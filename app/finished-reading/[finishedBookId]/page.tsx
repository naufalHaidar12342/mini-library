...
export async function generateMetadata({
	...
	return {
		title: `"${metadataBookTitle}" - Finished Reading`,
		description: `Currently finished reading book: "${metadataBookTitle}" by ${metadataBookAuthors}`,
	};
}

export default async function FinishedBookDetailsPage({
	params,
}: {
